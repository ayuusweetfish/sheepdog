...
return {
  ...
  [3] = {
    ...
    tutorial = {
      {-1, 'btn_storehouse 3'},
      {0.16, 0.35, 'try the crossroads', 'storehouse_click 3'},
      {-1, 'cell 3 3'},
      ...
      {0, 0, '', 'delay 540'},
      {0.45, 0.48, 'the sheep are confused!', 'delay 480'},
      {-1, 'btn_run'},
      {0.45, 0.48, 'the sheep are confused!', nil, {instant = true}},
      {0.05, 0.8, 'so let\'s go back and change a bit', 'stop'},
      {-1, 'btn_storehouse 5'},
      {0.12, 0.48, 'the dog will help you', 'storehouse_click 5'},
      {-1, 'cell 3 3'},
  ...
  [4] = {
    ...
    tutorial = {
      ...
      {-1, 'btn_storehouse 5'},
      {-1, 'cell 3 3'},
      {0.5, 0.67, 'we need a dog here', 'put 3 3'},
      {-1, 'btn_run'},
      {0, 0, '', 'run'},
      {0.5, 0.67, 'wait', 'delay 1080'},
      {-1, 'cell 3 3'},
      {0.5, 0.67, 'click the dog to turn', 'rotate_dog 3 3', {blocksBoard = true}},
      {0.5, 0.67, 'now the other flock go to their home'},
    }
  },
  [5] = {
    {4, 3, 2, 0, 2},
