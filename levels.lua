...
return {
  [1] = {
    ...
    tutorial = {
      ...
      {-1, 'cell 3 2'},
      {0.5, 0.77, '放在这里', 'put 3 2'},
      {-1, 'cell 3 2', nil, nil, {instant = true}},
      {0.5, 0.77, '点击以旋转', 'rotate_path 3 2'},
  ...
  [2] = {
    ...
    tutorial = {
      {-1, 'btn_storehouse 1'},
      {0.17, 0.08, '原材料好像不够呢……', 'storehouse_click 1'},
      {-1, 'cell 2 3'},
      {0.35, 0.35, '不过总之先试试？', 'put 2 3'},
      {-1, 'cell 2 3', nil, nil, {instant = true}},
      {0.35, 0.35, '不过总之先试试？', 'rotate_path 2 3', {instant = true}},
      {-1, 'btn_run', nil, 'run'},
      {0, 0, '', 'delay 1080'},
      {-1, 'cell 2 3'},
      {-1, 'cell 2 8'},
      {0.56, 0.6, '把刚才放置的格子拖到这里', 'put 2 8'},
    }
  },
  [3] = {
    {0, 0, 2, 0, 2},
    ...
    tutorial = {
      ...
      {-1, 'cell 3 3'},
      {0.45, 0.48, '放置在这里', 'put 3 3'},
      {-1, 'cell 3 3', nil, nil, {instant = true}},
      {0.45, 0.48, '点击旋转', 'rotate_path 3 3'},
      {-1, 'btn_run'},
      {0.05, 0.785, '小羊能顺利通行吗？', 'run'},
      {0, 0, '', 'delay 540'},
      {0.45, 0.7, '小羊还不太会认路呢！', 'delay 480'},
      {-1, 'btn_run'},
      {0.45, 0.7, '小羊还不太会认路呢！', nil, {instant = true}},
      {0.05, 0.8, '需要我们做些改动', 'stop'},
      {-1, 'btn_storehouse 5'},
      {0.17, 0.6, '牧羊犬是小羊的好伙伴', 'storehouse_click 5'},
      {-1, 'cell 3 3'},
      {0.45, 0.48, '交叉路口需要放置牧羊犬引路', 'put 3 3'},
  ...
  [4] = {
    ...
    tutorial = {
      ...
      {-1, 'btn_storehouse 5'},
      {-1, 'cell 3 3'},
      {0.5, 0.68, '在这里放置牧羊犬', 'put 3 3'},
      {-1, 'btn_run'},
      {0, 0, '', 'run'},
      {0.5, 0.68, '第一群小羊顺利抵达羊圈……', 'delay 1080'},
      {-1, 'cell 3 3'},
      {0.5, 0.68, '点击改变牧羊犬指引的方向', 'rotate_dog 3 3', {blocksBoard = true}},
      {0.5, 0.68, '第二群小羊也能回到正确的羊圈了！'},
    }
  },
  [5] = {
    {4, 3, 2, 0, 2},
